...
이 저장소는 SQL 강의를 들으며 배운 개념, 문법, 그리고 실습 쿼리를 기록하고 복습하기 위한 공간입니다. 노션(Notion)에 상세히 정리한 내용을 바탕으로 핵심 코드를 커밋합니다.
...
| 챕터 | 주제 | 주요 내용 | 링크 |
| :---: | :--- | :--- | :---: |
| **Ch 01** | **데이터 세팅 및 내부 조인** | 실습 테이블 준비 및 `INNER JOIN` 기본 문법 | [이동](./ch01_join) |
| Ch 02 | (다음 학습 주제) | | |
| Ch 03 | (다음 학습 주제) | | |
...
- `docs:` 학습 노트(Markdown) 추가 및 수정
- `feat:` 새로운 실습 쿼리 작성 및 문제 풀이
- `fix:` 잘못된 쿼리 수정 또는 오타 수정
